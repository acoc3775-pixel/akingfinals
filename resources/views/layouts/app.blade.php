...
<body>
    ...
    <nav class="navbar">
        <div class="nav-inner">
            <a href="{{ route('reservations.index') }}" class="nav-brand">
                <span class="brand-icon">📋</span>
                ReserveList
            </a>
            <div class="nav-links">
                <a href="{{ route('reservations.index') }}" class="nav-link">All Reservations</a>
                <a href="{{ route('reservations.create') }}" class="btn btn-primary btn-sm">+ New</a>
            </div>
        </div>
    </nav>
