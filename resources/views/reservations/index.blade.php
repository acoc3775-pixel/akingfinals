...
<form method="GET" action="{{ route('reservations.index') }}" class="filter-bar">
    ...
    @if(request('search') || request('status'))
        <a href="{{ route('reservations.index') }}" class="btn btn-ghost">Clear</a>
    @endif
</form>
...
@if($reservations->isEmpty())
    <div class="empty-state">
        ...
        <p>Try a different filter, or <a href="{{ route('reservations.create') }}">add a new one</a>.</p>
    </div>
@else
        ...
        <table class="res-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="res-date">{{ $reservation->reservation_date->format('M d, Y') }}</div>
                        <div class="res-time">{{ \Carbon\Carbon::parse($reservation->reservation_time)->format('g:i A') }}</div>
                    </td>
                    ...
                    <td>
                        <div class="action-group">
                            {{-- View --}}
                            <a href="{{ route('reservations.show', $reservation) }}" class="btn-icon" title="View">👁</a>

                            {{-- Edit --}}
                            <a href="{{ route('reservations.edit', $reservation) }}" class="btn-icon" title="Edit">✏️</a>
